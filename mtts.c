...
int main(int argc, char *argv[]) {
    if (argc != 4) {
        printf("Uso: %s <numero de tarefas trabalhadoras> <numero de caracteres por bloco> <ficheiro.txt>\n", argv[0]);
    ...
    // teste se o numeros de argumentos (tarefas "nt" e caracteres "nc" é correto ambos >=1
    if (nt >=1) {
        printf("O número de tarefas deve ser maior que zero.\n");
        return 1;
    }

    if (nc >=1) {
        printf("O número de caracteres por bloco deve ser maior que zero.\n");
        return 1;
    }
